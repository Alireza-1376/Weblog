...
export default function RegisterPage() {
    ...
    return (
        <Formik
            ...
            onSubmit={onSubmit}
        >
            <main className="h-screen w-screen flex items-center justify-center bg-linear-to-br from-teal-600 to-teal-600 dark:from-slate-800 dark:to-slate-700 p-4 overflow-y-auto">
                <div className="w-full max-w-md">
                    <div className="rounded-3xl border border-white/20 dark:border-slate-600 bg-white/10 dark:bg-slate-800 backdrop-blur-xl shadow-2xl p-8 py-6">
                        ...
                        <Form className="space-y-5">
                            ...
                            <button
                                type="submit"
                                className="w-full cursor-pointer rounded-xl bg-white dark:bg-slate-600 py-3 font-semibold text-slate-800 dark:text-white transition-all duration-300 hover:scale-[1.02] hover:bg-slate-100 dark:hover:bg-slate-700 active:scale-[0.98]"
                            >
                                ثبت نام
                            </button>
                        </Form>
                        ...
                        <div className="mt-6 flex flex-col gap-3 text-center">
                            ...
                            <Link
                                href="/"
                                className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/20 dark:border-slate-600 bg-white/10 dark:bg-slate-700 px-4 py-3 text-white transition-all duration-300 hover:bg-white/20 dark:hover:bg-slate-600 hover:scale-[1.02]"
                            >
                                <svg
                                    className="h-5 w-5"
                                    fill="none"
